...
--
-- Host: localhost
-- Generation Time: Dec 25, 2022 at 07:46 PM
...
CREATE TABLE `transactions` (
  ...
  `t_description` varchar(256) DEFAULT NULL,
...
ALTER TABLE `transactions`
  ...
  ADD KEY `transaction_type_fkey` (`tt_id`),
  ADD KEY `account_fkey` (`a_id`);
...
--
ALTER TABLE `transactions`
  ADD CONSTRAINT `account_fkey` FOREIGN KEY (`a_id`) REFERENCES `account` (`a_id`),
  ADD CONSTRAINT `transaction_type_fkey` FOREIGN KEY (`tt_id`) REFERENCES `transaction_type` (`tt_id`);
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"money_tracker\",\"table\":\"account\"},{\"db\":\"money_tracker\",\"table\":\"transactions\"},{\"db\":\"money_tracker\",\"table\":\"transaction_type\"}]');
...
('root', '2022-12-25 18:43:39', '{\"Console\\/Mode\":\"collapse\"}');
